    ...
    return (
        <aside className="left-sidebar">
            <nav className="nav-menu">
                <div className="nav-section-title">抽出・照合</div>
                <NavItem 
                    active={true}
                ...
                <div className="nav-section-title" style={{ marginTop: '2rem' }}>設定</div>
                <NavItem 
                    active={false}
            ...
            <div className="left-sidebar-footer">
                <div className="help-widget">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: '0.5rem' }}>
